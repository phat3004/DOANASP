    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null)
        {
            ...
            else
            {
                ...
                return View("ExternalLogin", new FacebookLoginModel { Email = email });
            }
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> ExternalLoginConfirmation(FacebookLoginModel model, string returnUrl = null)
        {
            if (!ModelState.IsValid)
                return View(model);
